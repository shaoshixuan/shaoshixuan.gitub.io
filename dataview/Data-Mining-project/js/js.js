    ...
    function echarts_1() {
        ...
        option = {
            ...
            legend: {
                ...
                orient: 'horizontal',
                data: ['平和', '生气', '疑惑', '开心', '喜欢','悲伤']
            },
            calculable: true,
            series: [{
                name: ' ',
                color: ['#62c98d', '#2fcfba', '#4cb9cf', '#53b666', '#62c98d', '#205acf', '#c9c862', '#c98b62', '#c962b9', '#7562c9', '#c96262', '#c25775', '#00b7be'],
                type: 'pie',
                radius: [40, 60],
                center: ['50%', '70%'],
                roseType: 'radius',
    ...
    function echarts_3() {
        ...
        option = {
            ...
            xAxis: [{
                ...
                data: ['2024-11-02', '2024-11-03', '2024-11-04', '2024-11-05', '2024-11-06', '2024-11-07', '2024-11-08', '2024-11-09',
                    '2024-11-10', '2024-11-11', '2024-11-12', '2024-11-13', '2024-11-14', '2024-11-15'
                ]
            }, {
            ...
            series: [{
                ...
                data: [0,54454,46760242,12912880,9458734,3323288,1581062,922682,549080,367182,186910,105820,57842,37442]
            }, {
                name: '讨论量',
                type: 'line',
                smooth: true,
                ...
                data: [0,30,28409,14491,6755,3052,1381,809,355,326,205,2167,715,78]
            }, {
                name: '互动量',
                type: 'line',
                smooth: true,
